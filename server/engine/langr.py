...
CK = {
 ...
 "a1_high": {"uz": "Likvidlik normadan yuqori — to'lov xavfi yo'q; ortiqcha mablag'ni aylanmaga yoki investitsiyaga yo'naltirish mumkin", "ru": "Ликвидность выше нормы — риска неплатежей нет; избыточные средства можно направить в оборот или инвестиции", "en": "Liquidity above the norm — no payment risk; excess funds could be put to work or invested"},
 "a2_high": {"uz": "Tezkor likvidlik normadan yuqori — to'lov qobiliyati kuchli; mablag' samaradorligini oshirish mumkin", "ru": "Быстрая ликвидность выше нормы — платёжеспособность высокая; можно повысить отдачу средств", "en": "Quick ratio above the norm — solvency is strong; capital efficiency could be improved"},
 "b4_high": {"uz": "Manyovrlik normadan yuqori — kapitalning katta qismi aylanmada, moslashuvchanlik yuqori", "ru": "Манёвренность выше нормы — большая часть капитала в обороте, высокая гибкость", "en": "Maneuverability above the norm — most equity is in working capital, high flexibility"},
 "a3_high": {"uz": "Naqd zaxira juda katta — to'lov xavfi yo'q; bo'sh mablag' daromad keltirmayapti, qisqa muddatli joylashtirishni ko'rib chiqing", "ru": "Денежный резерв очень велик — риска неплатежей нет; свободные средства не приносят дохода, рассмотрите краткосрочное размещение", "en": "Cash reserve is very large — no payment risk; idle funds earn nothing, consider short-term placement"},
